...
item.onmousedown = function(e) {
   ...
   document.onmousemove = function(e) {
      ...
      root.matrixspeed = Math.round(newLeft / rightBoundary * 1000);
      result.innerHTML = Math.round(newLeft / rightBoundary * 1000);
   }
...
item.onmousedown = function (e) {
  ...
  document.onmousemove = function (e) {
    ...
    // Обновление результата
    root.matrixspeed = Math.round(newLeft / rightBoundary * 100);
...
>>>>>>> c56114e007b9b2ac387faab560ff79f251a68e14
  return false;
}